...
$this->layout('html', [
	...
	'bodyClass' => 'layout_home pageHome'
]);
?>

<header class="layout-header pageHome-header">
	<h1><?= $app->title ?></h1>
...
<div class="layout-content pageHome-content">
	<?php $this->insert('partials/menu-primary-options'); ?>
</div>
