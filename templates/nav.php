...
<nav role="navigation" class="menu-secondary">
	...
	<form action="<?= $app->getRoute('search', ['entity' => $entityName]) ?>" class="menu-secondary-search" data-module="search" method="get" tabindex="-1">
		...
		<input id="search-entity" name="query" type="search" placeholder="<?= isset($placeholder) ? $placeholder : p__('search', 'Search %s...', strtolower($entity->title)) ?>" value="<?= isset($search) ? $search->buildQuery() : ''; ?>">
